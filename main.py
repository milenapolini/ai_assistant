...
activationWord = 'computer' # Single Word to activate, like Alexa
...
def search_wolframAlpha(query =''):
    ...
    # Query resolved
        ...
        # if it's primary, or has the title of result of definition, then it's the official result
    ...
    while True:
        ...
        if query[0] == activationWord:
            ...
            if query[0] == 'go' and query[1] == 'to':
                speak('Opening...')
                query = ' '.join(query[2:])
                webbrowser.get('chrome').open_new(query)  # Specified the browser before
